...
/obj/item/stock_parts/cell/ammo/smallcharge
	name = "energy cell"
	desc = "An energy cell, typically used as ammunition for small-arms energy weapons."
	icon_state = "ec-full"
	maxcharge = 900

/obj/item/stock_parts/cell/ammo/smallercharge
	name = "energy cell"
	desc = "An energy cell, typically used as ammunition for small-arms energy weapons."
	icon_state = "ec-full"
	maxcharge = 400

/obj/item/stock_parts/cell/ammo/tinycharge
	name = "energy cell"
	desc = "An energy cell, typically used as ammunition for small-arms energy weapons."
	icon_state = "ec-full"
	maxcharge = 150

/obj/item/stock_parts/cell/ammo/bowcharge
	name = "energy cell"
	desc = "An energy cell, typically used as ammunition for small-arms energy weapons."
	icon_state = "ec-full"
	maxcharge = 50
...
/obj/item/stock_parts/cell/ammo/crystal
	name = "energy cell"
	desc = "An energy cell, typically used as ammunition for small-arms energy weapons."
	icon_state = "ec-full"
	maxcharge = 100