...
/obj/item/clothing/gloves/stormtrooper
	...
	desc = "gloves with light plating to protect from glancing shots."
	icon_state = "stormtrooper_gloves"
	item_state = "stormtrooper_gloves"
	siemens_coefficient = 0
	permeability_coefficient = 0.05
	strip_delay = 80
	cold_protection = HANDS
	...
	max_heat_protection_temperature = GLOVES_MAX_TEMP_PROTECT
	resistance_flags = NONE
	armor = list("melee" = 25, "bullet" = 0, "laser" = 20, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 80, "acid" = 50)
