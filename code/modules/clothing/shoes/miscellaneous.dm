...
/obj/item/clothing/shoes/stormboots
	name = "stormtrooper boots"
	desc = "standard-issue stormtrooper footwear."
...
/obj/item/clothing/shoes/smugboots
	name = "fine boots"
	desc = "Fine-leather boots."
	icon_state = "smugboot"
	item_state = "explorer"
	lefthand_file = 'icons/mob/inhands/equipment/security_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/security_righthand.dmi'
...
/obj/item/clothing/shoes/milboots
	name = "duty boots"
	desc = "Footwear designed for rough terrain and long-term wear ."
	icon_state = "milboots"
	item_state = "jackboots"
	lefthand_file = 'icons/mob/inhands/equipment/security_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/security_righthand.dmi'
...
/obj/item/clothing/shoes/republic
	name = "combat boots"
	desc = "Thick, tough boots."
	icon_state = "jackboots"
	item_state = "rep_Boots"
	lefthand_file = 'icons/mob/inhands/equipment/security_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/security_righthand.dmi'
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 50, "bio" = 10, "rad" = 0, "fire" = 70, "acid" = 50)
	strip_delay = 40
