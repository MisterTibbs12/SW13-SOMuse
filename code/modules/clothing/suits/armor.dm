...
/obj/item/clothing/suit/armor/vest/republicinf
	name = "republic protective vest"
	desc = "A stop gap meant to issue republic forces while new armour is designed, this vest provides adequate protection from blaster-fire."
	icon_state = "rebelarmourvest"
	item_state = "rebelarmourvest"
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 50, "bullet" = 40, "laser" = 50, "energy" = 60, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 90)
	dog_fashion = null
	resistance_flags = FIRE_PROOF
...
/obj/item/clothing/suit/armor/vest/stormtrooperarmour
	name = "stormtrooper armour"
	desc = "An iconic set of armour, stormtrooper armour is seen in use by Imperial splinter-factions, as well as other groups."
	icon_state = "Stormtrooperarmour"
	item_state = "Stormtrooperarmour"
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 50, "bullet" = 40, "laser" = 50, "energy" = 60, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 90)
	dog_fashion = null
	resistance_flags = FIRE_PROOF

/obj/item/clothing/suit/armor/vest/tiepilotarmour
	name = "imperial pilot suit"
	desc = "A space-resistant suit, issued to imperial pilots."
	icon_state = "tiepilotsuit"
	item_state = "tiepilotsuit"
	clothing_flags = STOPSPRESSUREDAMAGE | SHOWEROKAY
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 50, "bullet" = 40, "laser" = 39, "energy" = 20, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 90)
	dog_fashion = null
	resistance_flags = FIRE_PROOF

/obj/item/clothing/suit/armor/vest/jedirobe
	name = "jedi robe"
	desc = "A plain cloth robe, paired with a leather vest. Provides little protection, but that hardly matters to a Jedi."
	icon_state = "jedi"
	item_state = "jedi"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list("melee" = 30, "bullet" = 40, "laser" = 20, "energy" = 20, "bomb" = 8, "bio" = 0, "rad" = 0, "fire" = 40, "acid" = 40)
	dog_fashion = null
	resistance_flags = FIRE_PROOF

/obj/item/clothing/suit/armor/vest/darkjedirobe
	name = "dark jedi garb"
	desc = "A dark cloth robe, paired with a light metal chestplate. Provides little protection, but that hardly matters to a Sith."
	icon_state = "darkjedi"
	item_state = "darkjedi"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list("melee" = 30, "bullet" = 40, "laser" = 20, "energy" = 20, "bomb" = 8, "bio" = 0, "rad" = 0, "fire" = 40, "acid" = 40)
