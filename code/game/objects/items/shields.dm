...
/obj/item/shield/riot/tele/attack_self(mob/living/user)
	...
	if(active)
		...
		w_class = WEIGHT_CLASS_TINY
		slot_flags = ITEM_SLOT_BACK
		to_chat(user, "<span class='notice'>You ignite \the [src].</span>")
	else
		force = 3
		throwforce = 3
		throw_speed = 3
...
/obj/item/shield/lightsaber
	name = "light saber"
	desc = "An elegant weapon, for a more civilized age."
	icon_state = "greensaber0"
	lefthand_file = 'icons/mob/inhands/equipment/shields_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/shields_righthand.dmi'
	slot_flags = null
	force = 3
...
/obj/item/shield/lightsaber/hit_reaction(mob/living/carbon/human/owner, atom/movable/hitby, attack_text = "the attack", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
	if(active)
		return ..()
	return 0

/obj/item/shield/lightsaber/attack_self(mob/living/user)
	active = !active
	icon_state = "greensaber1"
	playsound(src.loc, 'sound/weapons/batonextend.ogg', 50, 1)
...
/obj/item/shield/lightsaber/red
	icon_state = "redsaber0"

/obj/item/shield/lightsaber/attack_self(mob/living/user)
	active = !active
	icon_state = "redsaber1"
	playsound(src.loc, 'sound/weapons/batonextend.ogg', 50, 1)