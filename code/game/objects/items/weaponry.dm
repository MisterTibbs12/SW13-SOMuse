...
/obj/item/switchblade/vibroknife
	name = "vibroknife"
	icon_state = "vibroknife"
	lefthand_file = 'icons/mob/inhands/weapons/swords_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/weapons/swords_righthand.dmi'
	desc = "A hand-held vibroknife. Once activated, the blade will be able to cut through armour like paper."
	flags_1 = CONDUCT_1
	force = 3
	w_class = WEIGHT_CLASS_SMALL
	throwforce = 5
	...
	extended_icon_state = "vibroknife_ext"

/obj/item/switchblade/lightsaber
	name = "Light saber"
	icon_state = "vibroknife"
	lefthand_file = 'icons/mob/inhands/weapons/swords_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/weapons/swords_righthand.dmi'
