...
/obj/structure/overmap/fighter/xwing
	name = "t-65 X-wing"
	desc = "A balance of speed, maneuverability and defense, the X-wing series of starfighters are by far the most p."
	icon = 'nsv13/icons/overmap/nanotrasen/fighter.dmi'
	icon_state = "xwing"
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 30, "bomb" = 30, "bio" = 100, "rad" = 90, "fire" = 90, "acid" = 80, "overmap_light" = 10, "overmap_heavy" = 5)
	sprite_size = 32
...
/obj/structure/overmap/fighter/tiefighter
	name = "tie fighter"
	desc = "Beloved by some for its' speed, hated by others for its fragility, the TIE series of fighters has been the faithful companion of the imperial pilot since the founding days of the Galactic Empire ."
	icon = 'nsv13/icons/overmap/imperial/fighter.dmi'
	icon_state = "Tie"
	armor = list("melee" = 60, "bullet" = 60, "laser" = 45, "energy" = 30, "bomb" = 30, "bio" = 100, "rad" = 90, "fire" = 90, "acid" = 80, "overmap_light" = 10, "overmap_heavy" = 5)
	sprite_size = 32
	damage_states = FALSE //temp
	max_integrity = 125 //Really really squishy!
	max_angular_acceleration = 200
