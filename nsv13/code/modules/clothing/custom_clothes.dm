...
/obj/item/clothing/head/helmet/space/hardsuit/imperialpilot
	name = "imperial pilot helmet"
	icon = 'nsv13/icons/obj/clothing/hats.dmi'
	alternate_worn_icon = 'nsv13/icons/mob/head.dmi'
	icon_state = "hardsuit0-pilot_helmet"
	item_state = "tiepilothelm1"
	item_color = "tiepilothelm1"
	desc = "A lightweight space-helmet designed to protect fighter pilots in combat situations."
	armor = list("melee" = 20, "bullet" = 30, "laser" = 30, "energy" = 10, "bomb" = 70, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100)
	resistance_flags = FIRE_PROOF | ACID_PROOF
	flags_inv = HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR //we want to see the mask
	heat_protection = HEAD
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT
...
/obj/item/clothing/suit/space/hardsuit/pilot
	...
	item_state = "pilot"
	item_color = "pilot"
	helmettype = /obj/item/clothing/head/helmet/space/hardsuit/imperialpilot
	armor = list("melee" = 40, "bullet" = 50, "laser" = 50, "energy" = 25, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100)
	resistance_flags = FIRE_PROOF | ACID_PROOF
	heat_protection = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
	max_heat_protection_temperature = FIRE_IMMUNITY_MAX_TEMP_PROTECT //this needed to be added a long fucking time ago

/obj/item/clothing/suit/space/hardsuit/imperialpilot
	name = "imperial pilot flightsuit"
	desc = "A space-proof flightsuit worn by fighter pilots in the Imperial navy."
	icon = 'nsv13/icons/obj/clothing/suits.dmi'
	icon_state = "swjumpsuit"
	item_state = "pilot"
	item_color = "swjumpsuit"
	helmettype = /obj/item/clothing/head/helmet/space/hardsuit/imperialpilot
	armor = list("melee" = 40, "bullet" = 50, "laser" = 50, "energy" = 25, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100)
	resistance_flags = FIRE_PROOF | ACID_PROOF
	heat_protection = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
...
/obj/item/clothing/head/ship/fleethelm
	name = "new republic helmet"
	desc = "An old design, used since the days of the Old Republic."
	icon_state = "fleethelm"
	item_state = "fleethelm"
	armor = list("melee" = 20, "bullet" = 5, "laser" = 45, "energy" = 45, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 5)

/obj/item/clothing/head/ship/stormtrooperhelm
	name = "stormtrooper helmet"
	desc = "An infamous design, seeing wide-spread use throughout the galaxy by the various Imperial successor factions."
	icon_state = "stormtrooper_helm"
	item_state = "stormtrooper_helm"
	armor = list("melee" = 20, "bullet" = 5, "laser" = 45, "energy" = 45, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 5)

/obj/item/clothing/head/ship/tiepilothelm
	name = "imperial pilot helmet"
	desc = "A helmet designed for imperial pilots."
	icon_state = "tiepilothelm1"
	item_state = "tiepilothelm1"
